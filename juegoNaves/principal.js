...
function create ()
{
//AQUI CARGAMOS EL FONDO PARA QUE VAYA ATRAS
...
puntos = this.add.text(10, 10, 'PUNTOS: 0', { font: '40px Open sans', fill: '#ffff00'});
titulo = this.add.text(500, 10, 'Dispara y mata el virus', { font: '40px Montserrat Bold', fill: '#FFFFFF'});
gameOver = this.add.text(100, 300, '', { font: '40px Montserrat', fill: '#ffff00'});
restart = this.add.text(100, 360, '', { font: '40px Montserrat', fill: 'ffffff'});
...
function contacto(nave){
    ...
    this.physics.pause();
    gameOver.setText('¡Te has contagiado!"');
    restart.setText('Actualiza la página para reiniciar el juego');
}
function contacto2(){
    nave.setTint(0xff0000);
    this.physics.pause();
